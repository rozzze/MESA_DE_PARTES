<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('Crear Roles') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Formulario para crear nuevo Rol') }}</flux:subheading>
        ...
        <div class="w-150">
            <form wire:submit="submit" class="mt-6 space-y-6">
                ...
                <flux:checkbox.group wire:model="permissions" label="Permisos">
                    ...
                    <flux:checkbox.all label="Seleccionar todos los Permisos"/>
