<div>
    <div class="relative mb-6 w-full">
        ...
        <flux:subheading size="lg" class="mb-6">{{ __('Formulario para crear nuevo usuario') }}</flux:subheading>
    ...
    <div>
        ...
        <div class="w-150">
            <form wire:submit="submit" class="mt-6 space-y-6">
                ...
                <flux:input wire:model="password" label="Password" type="password" placeholder="Contraseña" />
                <flux:input wire:model="confirm_password" label="Confirm Password" type="password" placeholder="Confirmar Contraseña" />
