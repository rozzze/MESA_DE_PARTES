<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('Crear Tipo de Documento') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Formulario para crear un nuevo tipo de documento procesable') }}</flux:subheading>
        <flux:separator variant="subtle" />
    </div>

    <div>
        <a href="{{ route('doctype.index') }}" class="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-teal-300 to-lime-300 group-hover:from-teal-300 group-hover:to-lime-300 dark:text-white dark:hover:text-gray-900 focus:ring-4 focus:outline-none focus:ring-lime-200 dark:focus:ring-lime-800">
