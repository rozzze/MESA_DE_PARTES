<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('Editar Tipo de Documento') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Formulario para editar tipo de documento procesable') }}</flux:subheading>
